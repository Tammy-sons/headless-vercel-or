              ...
              {!cart || cart.lines.length === 0 ? (
                ...
                <div className="flex h-full flex-col justify-between overflow-hidden p-1">
                                ...
                                {item.merchandise.selectedOptions.length > 0 && (
                                  <div className="mt-1 flex flex-col">
                                    {item.merchandise.selectedOptions.map((option) => (
                                      <p key={option.name} className="text-xs text-neutral-600">
                  ...
                  <a
                    ...
                    className="block w-full rounded-full bg-[#285e2c] p-3 text-center text-sm font-black uppercase tracking-widest text-white hover:bg-[#3aae93] transition-colors"
                  >
                    Proceed to Checkout
                  </a>
                </div>
